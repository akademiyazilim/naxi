...
import { Collection as CollectionRaw, DeepPartial, Field } from '@naxi/types';
import { getCollectionType } from '@naxi/utils';
...
export const useCollectionsStore = defineStore('collectionsStore', () => {
	...
	/**
	 * All non-system collections that have a meta object, i.e. are configured in naxi
	 */
