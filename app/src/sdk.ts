...
import type { AuthenticationClient, naxiClient, RestClient } from '@naxi/sdk';
import { authentication, createnaxi, rest } from '@naxi/sdk';
...
export type SdkClient = naxiClient<any> & AuthenticationClient<any> & RestClient<any>;
...
export const sdk: SdkClient = createnaxi(getPublicURL(), { globals: { fetch: baseClient.native } })
