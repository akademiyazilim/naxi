...
/**
 * This file is a modified version of the attaches and image tool from editorjs to work with the naxi file manager.
 *
 * We include an uploader to directly use naxi file manager, along with a modified version of the attaches and image tools.
 */
