...
import { Field, GeoJSONParser, GeoJSONSerializer, GeometryType, MultiGeometry, SimpleGeometry } from '@naxi/types';
...
const activeLayers = [
	...
	'naxi-polygon-fill',
	'naxi-polygon-stroke',
	'naxi-polygon-midpoint',
	'naxi-polygon-and-line-vertex',
