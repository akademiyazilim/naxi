...
import { naxi_LOGO } from './constants';
...
async function init() {
	console.log(naxi_LOGO);

	console.info(
		`Hey! Interested in helping build this open-source data management platform?\nIf so, join our growing team of contributors at: https://naxi.chat`,
	);

	console.info(`%c🐰 Starting naxi...`, 'color:Green');
