...
import type { AppExtensionConfigs, AppExtensionType, HybridExtensionType } from '@naxi/extensions';
import type { Plural } from '@naxi/types';
import { pluralize } from '@naxi/utils';
