...
import { applyOptionsData } from '@naxi/utils';
...
const { updateAllowed } = useItemPermissions('naxi_panels', props.primaryKey, false);
...
<template>
	...
	<private-view v-else :title="currentDashboard.name">
		...
		<template #sidebar>
			...
			<comments-sidebar-detail :key="primaryKey" collection="naxi_dashboards" :primary-key="primaryKey" />
