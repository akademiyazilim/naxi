...
import type { User } from '@naxi/types';
...
const { info: collectionInfo } = useCollection('naxi_users');
	...
	<private-view :title="title">
		...
		<template #sidebar>
			...
			<revisions-drawer-detail
				...
				@revert="revert"
			/>
			<comments-sidebar-detail v-if="isNew === false" collection="naxi_users" :primary-key="primaryKey" />
		</template>
	</private-view>
</template>
