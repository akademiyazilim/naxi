...
<template>
	<v-list nav>
		...
		<v-list-item href="https://github.com/naxi/naxi/releases" class="version">
			<v-list-item-icon><v-icon name="naxi" /></v-list-item-icon>
			<v-list-item-content>
				<v-text-overflow class="version" :text="`naxi ${info.version}`" />
			</v-list-item-content>
		</v-list-item>
	</v-list>
</template>
