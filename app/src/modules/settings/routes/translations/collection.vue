...
import { useCollection, useLayout } from '@naxi/composables';
...
const { info: currentCollection } = useCollection('naxi_translations');
...
<template>
	...
	>
		...
		>
			...
			<template #actions>
				<search-input v-model="search" v-model:filter="filter" collection="naxi_translations" />
