...
import { useApi } from '@naxi/composables';
import { Alterations, Item, Policy } from '@naxi/types';
...
const policiesField = cloneDeep(fieldsStore.getField('naxi_roles', 'policies'));
