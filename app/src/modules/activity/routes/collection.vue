...
const { layout, layoutOptions, layoutQuery, filter, search } = usePreset(ref('naxi_activity'));
...
<template>
	...
	>
		...
		>
			...
			<template #actions>
				<search-input v-model="search" v-model:filter="filter" collection="naxi_activity" />
			</template>
