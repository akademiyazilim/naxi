...
import { useCollection, useItems, useSync } from '@naxi/composables';
import { defineLayout } from '@naxi/extensions';
import { Field, Filter, GeometryOptions } from '@naxi/types';
import { getFieldsFromTemplate, mergeFilters } from '@naxi/utils';
...
export default defineLayout<LayoutOptions, LayoutQuery>({
	...
	setup(props, { emit }) {
		...
		function updateSource() {
			naxiSource.value = merge({}, naxiSource.value, {
