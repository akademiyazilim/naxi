...
export const DEFAULT_REPORT_BUG_URL = 'https://github.com/naxi/naxi/issues/new?template=bug_report.yml';
export const DEFAULT_REPORT_FEATURE_URL =
	'https://github.com/naxi/naxi/discussions/new?category=feature-requests';
