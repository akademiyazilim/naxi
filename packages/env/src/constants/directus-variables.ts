/**
 * Variables in the environment that naxi will read as configuration
 */
export const naxi_VARIABLES = [
	// general
	'CONFIG_PATH',
	'HOST',
	'PORT',
...
/**
 * Variables in the environment that naxi will read as configuration in RegExp format
 */
export const naxi_VARIABLES_REGEX = naxi_VARIABLES.map((name) => new RegExp(`^${name}$`));
