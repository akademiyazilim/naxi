...
import { EXTENSION_LANGUAGES, EXTENSION_TYPES, BUNDLE_EXTENSION_TYPES } from '@naxi/extensions';
import { create } from '@naxi/extensions-sdk/cli';

run();

async function run() {
	// eslint-disable-next-line no-console
	console.log('This utility will walk you through creating a naxi extension.\n');
