 ...
 */
export const APP_SHARED_DEPS = ['@naxi/extensions-sdk', 'vue', 'vue-router', 'vue-i18n', 'pinia'];

/**
 * Dependencies that we guarantee are available in the node_modules of the API when API extensions
 * are used. The `naxi:*` extensions are virtual entrypoints available in the sandbox
 */
export const API_SHARED_DEPS = ['naxi', 'naxi:api'];
