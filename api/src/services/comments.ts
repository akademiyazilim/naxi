...
import { ErrorCode, ForbiddenError, InvalidPayloadError, isnaxiError } from '@naxi/errors';
import type { Accountability, Comment, PrimaryKey } from '@naxi/types';
...
`;
				...
				if (isnaxiError(err, ErrorCode.Forbidden)) {
