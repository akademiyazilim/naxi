import { isnaxiError, type naxiError } from '@naxi/errors';
...
const processError = (
	...
	error: Readonly<GraphQLError & { originalError: GraphQLError | naxiError | Error | undefined }>,
