...
import { TokenExpiredError, InvalidTokenError } from '@naxi/errors';
import { ServiceUnavailableError } from '@naxi/errors';

const payload: naxiTokenPayload = { role: null, app_access: false, admin_access: false };
const secret = 'test-secret';
const options = { issuer: 'naxi' };
...
const RequiredEntries: Array<keyof naxiTokenPayload> = ['role', 'app_access', 'admin_access'];
