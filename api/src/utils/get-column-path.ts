import type { Relation, SchemaOverview } from '@naxi/types';
...
/**
 * Converts a naxi field list path to the correct SQL names based on the constructed alias map.
 * For example: ['author', 'role', 'name'] -> 'ljnsv.name'
 * Also returns the target collection of the column: 'naxi_roles'
