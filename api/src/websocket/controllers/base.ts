...
import { InvalidProviderConfigError, TokenExpiredError } from '@naxi/errors';
import type { Accountability } from '@naxi/types';
import { parseJSON, toBoolean } from '@naxi/utils';
...
export default abstract class SocketController {
	...
	private catchInvalidMessages(ws: WebSocket) {
		 ...
		 * https://github.com/naxi/naxi/security/advisories/GHSA-hmgw-9jrg-hf2m
