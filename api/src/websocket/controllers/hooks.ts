...
function registerFieldsHooks() {
	// exception for field hooks that don't report `naxi_fields` as being the collection
...
function registerRelationsHooks() {
	// exception for relation hooks that don't report `naxi_relations` as being the collection
