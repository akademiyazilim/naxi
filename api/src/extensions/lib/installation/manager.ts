...
import { EXTENSION_PKG_KEY, ExtensionManifest } from '@naxi/extensions';
import { download, type DownloadOptions } from '@naxi/extensions-registry';
import DriverLocal from '@naxi/storage-driver-local';
