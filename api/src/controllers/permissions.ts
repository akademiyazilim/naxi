import { ErrorCode, ForbiddenError, isnaxiError } from '@naxi/errors';
...
router.use(useCollection('naxi_permissions'));
...
const readHandler = asyncHandler(async (req, res, next) => {
	...
	// temporary fix for missing permissions https://github.com/naxi/naxi/issues/18654
	...
	const meta = await metaService.getMetaForQuery('naxi_permissions', temporaryQuery);
