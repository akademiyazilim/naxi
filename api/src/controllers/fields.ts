...
import { isnaxiError } from '@naxi/errors';
import type { Field, RawField, Type } from '@naxi/types';
import { Router } from 'express';
import Joi from 'joi';
import { ALIAS_TYPES } from '../constants.js';
import { ErrorCode, InvalidPayloadError } from '@naxi/errors';
...
router.use(useCollection('naxi_fields'));
