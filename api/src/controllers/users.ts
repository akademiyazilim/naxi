...
import type { PrimaryKey, RegisterUserInput } from '@naxi/types';
...
router.use(useCollection('naxi_users'));
...
const readHandler = asyncHandler(async (req, res, next) => {
	...
	const meta = await metaService.getMetaForQuery('naxi_users', req.sanitizedQuery);
