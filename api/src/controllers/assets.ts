...
import { InvalidQueryError, RangeNotSatisfiableError } from '@naxi/errors';
import type { Range } from '@naxi/storage';
...
router.get(
	...
	asyncHandler(async (req, res, next) => {
		const payloadService = new PayloadService('naxi_settings', { schema: req.schema });
