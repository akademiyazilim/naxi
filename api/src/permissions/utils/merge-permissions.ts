import type { LogicalFilterAND, LogicalFilterOR, Permission } from '@naxi/types';
import { flatten, intersection, isEqual, merge, omit, uniq } from 'lodash-es';

// Adapted from https://github.com/naxi/naxi/blob/141b8adbf4dd8e06530a7929f34e3fc68a522053/api/src/utils/merge-permissions.ts#L4
/**
