...
export type CreateRelationOutput<Schema, Item extends object = naxiRelation<Schema>> = ApplyQueryFields<
	Schema,
	Item,
	'*'
>;
...
export const createRelation =
	<Schema>(item: NestedPartial<naxiRelation<Schema>>): RestCommand<CreateRelationOutput<Schema>, Schema> =>
	() => ({
		path: `/relations`,
