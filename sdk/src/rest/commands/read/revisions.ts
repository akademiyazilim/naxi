import type { naxiRevision } from '../../../schema/revision.js';
...
export type ReadRevisionOutput<
	...
	Item extends object = naxiRevision<Schema>,
> = ApplyQueryFields<Schema, Item, TQuery['fields']>;

/**
 * List all Revisions that exist in naxi.
...
export const readRevisions =
	<Schema, const TQuery extends Query<Schema, naxiRevision<Schema>>>(
		query?: TQuery,
