...
export type ReadRelationOutput<Schema> = ApplyQueryFields<Schema, naxiRelation<Schema>, '*'>;

/**
 * List all Relations that exist in naxi.
...
export const readRelationByCollection =
	<Schema>(collection: naxiRelation<Schema>['collection']): RestCommand<ReadRelationOutput<Schema>[], Schema> =>
	() => ({
