import type { naxiActivity } from '../../../schema/activity.js';
...
export type ReadActivityOutput<
	...
	Item extends object = naxiActivity<Schema>,
...
export const readActivities =
	<Schema, const TQuery extends Query<Schema, naxiActivity<Schema>>>(
		query?: TQuery,
