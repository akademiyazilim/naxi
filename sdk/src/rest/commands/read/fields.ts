...
export type ReadFieldOutput<Schema, Item extends object = naxiField<Schema>> = ApplyQueryFields<Schema, Item, '*'>;
...
export const readFieldsByCollection =
	<Schema>(collection: naxiField<Schema>['collection']): RestCommand<ReadFieldOutput<Schema>[], Schema> =>
	() => {
