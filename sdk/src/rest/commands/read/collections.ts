...
export type ReadCollectionOutput<Schema, Item extends object = naxiCollection<Schema>> = ApplyQueryFields<
	Schema,
	Item,
	'*'
>;
...
export const readCollection =
	<Schema>(collection: naxiCollection<Schema>['collection']): RestCommand<ReadCollectionOutput<Schema>, Schema> =>
	() => {
