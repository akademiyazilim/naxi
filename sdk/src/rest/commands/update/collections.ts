...
export type UpdateCollectionOutput<
	...
	Item extends object = naxiCollection<Schema>,
...
export const updateCollection =
	<Schema, const TQuery extends Query<Schema, naxiCollection<Schema>>>(
		collection: naxiCollection<Schema>['collection'],
		item: NestedPartial<naxiCollection<Schema>>,
		query?: TQuery,
...
export const updateCollectionsBatch =
	<Schema, const TQuery extends Query<Schema, naxiCollection<Schema>>>(
		items: NestedPartial<naxiCollection<Schema>>[],
		query?: TQuery,
	): RestCommand<UpdateCollectionOutput<Schema, TQuery>, Schema> =>
	() => ({
		path: `/collections`,
