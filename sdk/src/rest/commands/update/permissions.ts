import type { naxiPermission } from '../../../schema/permission.js';
...
export type UpdatePermissionOutput<
	...
	Item extends object = naxiPermission<Schema>,
...
export const updatePermissions =
	<Schema, const TQuery extends Query<Schema, naxiPermission<Schema>>>(
		keys: naxiPermission<Schema>['id'][],
		item: Partial<naxiPermission<Schema>>,
		query?: TQuery,
...
export const updatePermissionsBatch =
	<Schema, const TQuery extends Query<Schema, naxiPermission<Schema>>>(
		items: NestedPartial<naxiPermission<Schema>>[],
		query?: TQuery,
	): RestCommand<UpdatePermissionOutput<Schema, TQuery>[], Schema> =>
	() => ({
		path: `/permissions`,
